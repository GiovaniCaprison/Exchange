...
#ifndef _EXCHANGE_PROTOCOL_CANCELORDER_CXX_H_
#define _EXCHANGE_PROTOCOL_CANCELORDER_CXX_H_
...
public:
    ...
    CancelOrder &clientOrderId(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    CancelOrder &participantId(const std::uint32_t value) SBE_NOEXCEPT
    {
