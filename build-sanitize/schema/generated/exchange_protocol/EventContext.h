...
#ifndef _EXCHANGE_PROTOCOL_EVENTCONTEXT_CXX_H_
#define _EXCHANGE_PROTOCOL_EVENTCONTEXT_CXX_H_
...
public:
    ...
    EventContext(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        EventContext(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    EventContext(
        char *buffer,
        const std::uint64_t bufferLength) :
        EventContext(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    EventContext &sequence(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *inputSequenceMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t inputSequenceId() SBE_NOEXCEPT
    {
        return -1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t inputSequenceSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool inputSequenceInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t inputSequenceEncodingOffset() SBE_NOEXCEPT
    {
        return 8;
    }

    static SBE_CONSTEXPR std::uint64_t inputSequenceNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT64;
    }

    static SBE_CONSTEXPR std::uint64_t inputSequenceMinValue() SBE_NOEXCEPT
    {
        return UINT64_C(0x0);
    }

    static SBE_CONSTEXPR std::uint64_t inputSequenceMaxValue() SBE_NOEXCEPT
    {
        return UINT64_C(0xfffffffffffffffe);
    }

    static SBE_CONSTEXPR std::size_t inputSequenceEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::uint64_t inputSequence() const SBE_NOEXCEPT
    {
        std::uint64_t val;
    ...
    EventContext &inputSequence(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    EventContext &timestamp(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    EventContext &instrumentId(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    EventContext &reserved(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, EventContext &writer)
{
    builder << '{';
    builder << R"("sequence": )";
    ...
    builder << ", ";
    builder << R"("inputSequence": )";
    builder << +writer.inputSequence();
